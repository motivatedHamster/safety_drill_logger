...
Drill.create date_performed: Date::strptime("04-22-2015", "%m-%d-%Y"), date_due: Date::strptime("04-28-2015", "%m-%d-%Y"), teacher: teacher_patty, classroom: class_discoverers, drill_type: dtype_fire_discoverers
Drill.create date_performed: Date::strptime("09-23-2014", "%m-%d-%Y"), date_due: Date::strptime("12-31-2014", "%m-%d-%Y"), teacher: teacher_patty, classroom: class_discoverers, drill_type: dtype_quake_discoverers
Drill.create date_performed: Date::strptime("04-27-2015", "%m-%d-%Y"), date_due: Date::strptime("04-30-2015", "%m-%d-%Y"), teacher: teacher_jess, classroom: class_imagineers, drill_type: dtype_fire_imagineers
Drill.create date_performed: Date::strptime("09-23-2014", "%m-%d-%Y"), date_due: Date::strptime("12-31-2014", "%m-%d-%Y"), teacher: teacher_jess, classroom: class_imagineers, drill_type: dtype_quake_imagineers
Drill.create date_performed: Date::strptime("04-27-2015", "%m-%d-%Y"), date_due: Date::strptime("04-30-2014", "%m-%d-%Y"), teacher: teacher_jess, classroom: class_inventors, drill_type: dtype_fire_inventors
Drill.create date_performed: Date::strptime("09-23-2014", "%m-%d-%Y"), date_due: Date::strptime("12-31-2014", "%m-%d-%Y"), teacher: teacher_jess, classroom: class_inventors, drill_type: dtype_quake_inventors
Drill.create date_performed: Date::strptime("04-29-2015", "%m-%d-%Y"), date_due: Date::strptime("06-30-2014", "%m-%d-%Y"), teacher: teacher_jess, classroom: class_adventurers, drill_type: dtype_fire_adventurers
Drill.create date_performed: Date::strptime("09-23-2014", "%m-%d-%Y"), date_due: Date::strptime("12-31-2014", "%m-%d-%Y"), teacher: teacher_jess, classroom: class_adventurers, drill_type: dtype_quake_adventurers
